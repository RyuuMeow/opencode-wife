...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    items: [
      { type: "item", labelKey: "desktop.menu.documentation", href: "https://github.com/RyuuMeow/opencode-wife" },
      { type: "item", labelKey: "desktop.menu.supportForum", href: "https://github.com/RyuuMeow/opencode-wife/issues" },
      { type: "item", labelKey: "desktop.menu.exportLogs", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        labelKey: "desktop.menu.shareFeedback",
        href: "https://github.com/RyuuMeow/opencode-wife/issues/new",
      },
      {
        type: "item",
