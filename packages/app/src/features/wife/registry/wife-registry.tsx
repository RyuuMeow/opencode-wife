...
import type { AvatarProfile, CharacterCapabilities, CharacterDefinition } from "@opencode-ai/wife-core"
...
export const { use: useWifeRegistry, provider: WifeRegistryProvider } = createSimpleContext({
  ...
  init: () => {
    ...
    const register = (input: CharacterImport) => {
      ...
      setStore("capabilities", id, input.capabilities)
      return id
    }
