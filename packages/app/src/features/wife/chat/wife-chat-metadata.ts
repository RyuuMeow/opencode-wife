...
export const WIFE_METADATA_CHOICE_VALUE = "choice"
...
export function isWifeInternalMetadata(metadata: unknown) {
  ...
  return (
    metadata[WIFE_METADATA_KIND] === WIFE_METADATA_VALUE ||
    metadata[WIFE_METADATA_KIND] === WIFE_METADATA_HANDOFF_VALUE ||
    metadata[WIFE_METADATA_KIND] === WIFE_METADATA_CHOICE_VALUE
  )
}
