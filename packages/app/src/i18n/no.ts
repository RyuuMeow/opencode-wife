...
export const dict = {
  ...
  "settings.general.row.wifeCharacters.description": "Registrer og administrer karakterfølgesvenner",
  ...
  "wife.import.step.folder.description": "Velg mappen som inneholder Live2D-modellen din (.model3.json)",
