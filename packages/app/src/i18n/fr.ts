export const dict = {
  ...
  "wife.runtime.description": "Download the compatible Cubism Core from the official Live2D CDN, then select live2dcubismcore.min.js. Side Chat works without it.",
  "wife.runtime.download": "Download compatible core",
