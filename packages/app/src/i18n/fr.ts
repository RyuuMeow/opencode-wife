export const dict = {
  ...
  "wife.runtime.description": "Download the Web SDK from Live2D, accept its terms, then select the SDK ZIP or live2dcubismcore.min.js. Side Chat works without it.",
