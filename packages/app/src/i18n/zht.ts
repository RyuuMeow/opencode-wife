...
export const dict = {
  ...
  "wife.characters.empty": "尚未註冊任何角色",
  "wife.characters.unconfigured": "未設定",
  "wife.characters.newDefault": "新角色",
  "wife.characters.settings.changeModel": "更換模型",
  "wife.characters.settings.model": "Live2D 模型",
  "wife.characters.settings.delete": "刪除角色",
  "wife.characters.settings.removeAvatar": "移除頭像",
  "wife.characters.settings.general": "一般",
  "wife.characters.settings.persona": "角色人設",
  "wife.characters.settings.personaDescription": "設定角色在 Side Chat 中對你的稱呼與說話方式",
  "wife.characters.settings.userAddress": "對你的稱呼",
  "wife.characters.settings.userAddressDescription": "角色用來稱呼你的名字或稱謂，可留空",
  "wife.characters.settings.userAddressPlaceholder": "例如：隊長",
  "wife.characters.settings.personaInstructions": "人設與說話方式",
  "wife.characters.settings.personaInstructionsDescription": "描述角色的性格、關係、語氣與對話習慣",
  "wife.characters.settings.personaInstructionsPlaceholder": "例如：冷靜而敏銳，說話自然，偶爾帶點溫柔的幽默",
  "wife.characters.settings.dangerZone": "危險區域",
  "wife.characters.settings.nameDescription": "角色顯示名稱",
  "wife.characters.settings.modelDescription": "選擇包含模型與其所有資產的資料夾(.model3.json、.moc3、貼圖、動作)",
  "wife.characters.settings.avatarDescription": "此角色的方形顯示圖片",
  "wife.characters.settings.mappingDescription": "將動作與表情對應到角色狀態",
  "wife.characters.settings.deleteDescription": "永久移除角色與其設定",
  "wife.characters.edit": "編輯",
  "wife.characters.settings": "角色設定",
  "wife.characters.settings.avatar": "頭像",
  "wife.characters.backToList": "返回角色列表",
  "wife.import.title": "新增角色",
  "wife.import.step.scan.title": "掃描結果",
  "wife.import.step.mapping.title": "語意對應",
  "wife.import.chooseFolder": "選擇資料夾",
  "wife.import.noModelFound": "此資料夾中找不到 .model3.json 檔案",
  "wife.import.oversized": "部分資源超過 200 MB 大小限制,將被略過",
  "wife.import.name": "角色名稱",
  "wife.scan.motions": "動作",
  "wife.scan.expressions": "表情",
  "wife.scan.parameters": "參數",
  "wife.scan.lipSync": "口型同步",
  "wife.scan.eyeBlink": "眨眼",
  "wife.scan.gaze": "視線",
  "wife.scan.angle": "角度",
  "wife.scan.mouthForm": "嘴形",
  "wife.scan.issues": "問題",
  "wife.scan.yes": "是",
  "wife.scan.no": "否",
  "wife.mapping.states": "狀態",
  "wife.mapping.gestures": "手勢",
  "wife.mapping.emotions": "情緒",
  "wife.mapping.none": "無",
  "wife.mapping.fallback": "回退至",
  "wife.panel.test.emotion.embarrassed": "害羞",
  "wife.panel.test.state.error": "錯誤",
  ...
  "wife.panel.test.emotion.happy": "開心",
  ...
  "wife.panel.empty.web": "Live2D 渲染僅限桌面版應用程式",
  "wife.panel.test.emotion.neutral": "中性",
  "wife.panel.test.emotion.concerned": "擔憂",
  "wife.panel.test.gesture.look_at_user": "看向您",
  "wife.panel.test.none": "無",
  "wife.panel.test.gesture.celebrate": "慶祝",
  "wife.panel.test.state.speaking": "說話中",
  ...
  "wife.panel.commands.send.title": "傳送給 Agent",
  "wife.panel.commands.send.description": "將這段 Side Chat 整理成可編輯的 Agent prompt",
  "wife.panel.commands.send.working": "正在整理給 Agent",
  "wife.panel.commands.send.draftTitle": "Agent 草稿已有內容",
  "wife.panel.commands.send.draftDescription": "取代現有文字與提及，或將整理後的任務附加在後方。",
  "wife.panel.commands.send.replace": "取代",
  "wife.panel.commands.send.append": "附加",
  "wife.panel.commands.clear.title": "清空 Side Chat",
  "wife.panel.commands.clear.suggestionDescription": "永久清除這段 Side Chat 與記憶",
  "wife.panel.commands.clear.description": "這會永久刪除目前的 Side Chat 歷史與記憶。",
  "wife.panel.commands.clear.confirm": "清空",
  "wife.panel.commands.clear.working": "正在清空 Side Chat",
  "wife.panel.chat.historyTitle": "聊天記錄",
  "wife.panel.chat.historyClose": "關閉聊天記錄",
  "wife.panel.chat.roleAssistant": "夥伴",
  ...
  "settings.wife.section.bubbles": "對話氣泡",
  "settings.wife.bubbles.textSize.title": "文字大小",
  "settings.wife.bubbles.textSize.description": "即時對話與歷史氣泡中的文字大小",
  "settings.wife.bubbles.textSize.small": "小",
  "settings.wife.bubbles.textSize.standard": "標準",
  "settings.wife.bubbles.textSize.large": "大",
  "settings.wife.bubbles.pace.title": "對話節奏",
  "settings.wife.bubbles.pace.description": "同一輪回覆中的氣泡顯示速度",
  "settings.wife.bubbles.pace.fast": "快速",
  "settings.wife.bubbles.pace.natural": "自然",
  "settings.wife.bubbles.pace.relaxed": "悠閒",
  "settings.wife.bubbles.contrast.title": "背景對比",
  "settings.wife.bubbles.contrast.description": "氣泡相對於 Live2D 背景的不透明程度",
  "settings.wife.bubbles.contrast.soft": "輕透",
  "settings.wife.bubbles.contrast.standard": "標準",
  "settings.wife.bubbles.contrast.strong": "清晰",
  "settings.wife.bubbles.motion.title": "動畫效果",
  "settings.wife.bubbles.motion.description": "訊息與歷史出現或離開時使用的動態效果",
  "settings.wife.bubbles.motion.full": "完整",
  "settings.wife.bubbles.motion.subtle": "簡化",
  "settings.wife.bubbles.motion.off": "關閉",
  "settings.wife.bubbles.header.title": "角色標頭",
  "settings.wife.bubbles.header.description": "角色頭貼與名字的顯示頻率",
  "settings.wife.bubbles.header.every": "每則顯示",
  "settings.wife.bubbles.header.turn": "每輪一次",
  "settings.wife.bubbles.header.hidden": "隱藏",
  "settings.wife.section.choices": "回覆選項",
  "settings.wife.section.data": "OpenCode 資料",
  "settings.wife.section.runtime": "Live2D 執行環境",
  "settings.wife.runtime.title": "Cubism Core",
  "settings.wife.runtime.installed": "使用者提供的 runtime 已安裝在 OpenCode Wife profile。",
  "settings.wife.runtime.missing": "尚未安裝；Live2D 為選用功能，Side Chat 仍可使用。",
  "settings.wife.runtime.replace": "替換",
  "settings.wife.runtime.remove": "移除",
  "wife.runtime.title": "設定 Live2D Cubism Core",
  "wife.runtime.description": "自動從 Live2D 官方 CDN 下載相容的 Cubism Core；下載即表示接受 Live2D 條款。未安裝時 Side Chat 仍可使用。",
  "wife.runtime.downloadAndInstall": "下載並安裝",
  "wife.runtime.chooseFile": "選擇檔案…",
  ...
  "wife.runtime.error.downloadFailed": "下載 Cubism Core 失敗。請檢查網路連線後重試。",
  "wife.runtime.installing": "安裝中…",
  "wife.runtime.license": "Live2D 授權資訊",
  "settings.wife.import.title": "匯入 OpenCode 偏好",
  "settings.wife.import.description": "重新匯入安全的介面偏好後重新啟動；不會取代 Wife 角色或共用的 Agent sessions。",
  "settings.wife.import.action": "匯入並重新啟動",
  "settings.wife.import.working": "匯入中…",
  "settings.wife.choices.enabled.title": "生成回覆選項",
  "settings.wife.choices.enabled.description": "每次 Wife 成功回覆後提供簡短的建議回覆",
  "settings.wife.choices.model.title": "選項生成模型",
  "settings.wife.choices.model.description": "使用獨立的低成本模型，不延遲主要回覆",
  "settings.wife.choices.model.unavailable": "所選模型或推理強度目前不可用",
  "settings.wife.choices.variant.title": "推理強度",
  "settings.wife.choices.variant.description": "簡短回覆選項通常使用較低推理強度即可",
