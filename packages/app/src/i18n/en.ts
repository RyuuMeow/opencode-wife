...
export const dict = {
  ...
  "settings.wife.section.choices": "Reply choices",
  ...
  "settings.wife.choices.enabled.title": "Generate reply choices",
  "settings.wife.choices.enabled.description": "Suggest short replies after each successful Wife response",
  "settings.wife.choices.model.title": "Choice generation model",
  "settings.wife.choices.model.description": "Uses a separate low-cost model without delaying the main response",
  "settings.wife.choices.model.unavailable": "The selected model or reasoning variant is unavailable",
  "settings.wife.choices.variant.title": "Reasoning effort",
  "settings.wife.choices.variant.description": "Lower effort is usually sufficient for short reply suggestions",
  ...
  "wife.scan.lipSync": "Lip sync",
  "wife.scan.eyeBlink": "Eye blink",
  "wife.scan.gaze": "Gaze",
  "wife.scan.angle": "Angle",
  "wife.scan.mouthForm": "Mouth form",
  "wife.scan.issues": "Issues",
  "wife.scan.yes": "yes",
  "wife.scan.no": "no",
  "wife.mapping.states": "States",
  "wife.mapping.gestures": "Gestures",
  "wife.mapping.emotions": "Emotions",
  "wife.mapping.none": "None",
  "wife.mapping.fallback": "Falls back to",
  ...
  "wife.panel.commands.send.title": "Send to Agent",
  "wife.panel.commands.send.description": "Turn this side chat into an editable Agent prompt",
  "wife.panel.commands.send.working": "Preparing for Agent",
  "wife.panel.commands.send.draftTitle": "The Agent draft is not empty",
  "wife.panel.commands.send.draftDescription": "Replace its text and mentions, or append the prepared task.",
  "wife.panel.commands.send.replace": "Replace",
  "wife.panel.commands.send.append": "Append",
  "wife.panel.commands.clear.title": "Clear side chat",
  "wife.panel.commands.clear.suggestionDescription": "Permanently clear this side chat and its memory",
  "wife.panel.commands.clear.description": "This permanently deletes the current side chat history and memory.",
  "wife.panel.commands.clear.confirm": "Clear",
  "wife.panel.commands.clear.working": "Clearing side chat",
  "wife.panel.chat.historyTitle": "Chat history",
  "wife.panel.chat.historyClose": "Close chat history",
