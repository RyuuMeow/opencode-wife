export const dict = {
  ...
  "command.session.export.description": "전체 세션 대화 내용을 JSON으로 내보내기",
  ...
  "toast.session.export.failed.title": "세션 내보내기에 실패했습니다",
  ...
  "wife.scan.parameters": "파라미터",
  "wife.scan.lipSync": "립싱크",
  "wife.scan.eyeBlink": "눈 깜빡임",
  "wife.scan.gaze": "시선",
  "wife.scan.angle": "각도",
  "wife.scan.mouthForm": "입 모양",
  "wife.scan.issues": "문제",
  "wife.scan.yes": "예",
  "wife.scan.no": "아니요",
  "wife.mapping.states": "상태",
  "wife.mapping.gestures": "제스처",
