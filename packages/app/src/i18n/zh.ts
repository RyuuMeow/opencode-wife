...
export const dict = {
  ...
  "wife.runtime.description": "请从 Live2D 下载 Web SDK 并接受其条款，再选择 SDK ZIP 或 live2dcubismcore.min.js。未安装时 Side Chat 仍可使用。",
  "wife.runtime.download": "打开官方下载页",
  ...
  "wife.runtime.install": "选择 SDK 文件",
