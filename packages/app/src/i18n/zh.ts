...
export const dict = {
  ...
  "settings.wife.section.data": "OpenCode 数据",
  "settings.wife.section.runtime": "Live2D 运行时",
  "settings.wife.runtime.title": "Cubism Core",
  "settings.wife.runtime.installed": "用户提供的 runtime 已安装在 OpenCode Wife profile。",
  "settings.wife.runtime.missing": "尚未安装；Live2D 为可选功能，Side Chat 仍可使用。",
  "settings.wife.runtime.replace": "替换",
  "settings.wife.runtime.remove": "移除",
  "wife.runtime.title": "设置 Live2D Cubism Core",
  "wife.runtime.description": "自动从 Live2D 官方 CDN 下载兼容的 Cubism Core；下载即表示接受 Live2D 条款。未安装时 Side Chat 仍可使用。",
  "wife.runtime.downloadAndInstall": "下载并安装",
  "wife.runtime.chooseFile": "选择文件…",
  "wife.runtime.error.coreNotFound": "所选 SDK ZIP 中找不到 live2dcubismcore.min.js。",
  "wife.runtime.error.invalidSize": "所选 Cubism Core 文件为空或过大。",
  "wife.runtime.error.invalidCore": "所选文件不是有效的 Live2D Cubism Core 运行时。",
  "wife.runtime.error.incompatibleCore": "此 Cubism Core 与内置运行时不兼容。请使用官方 CDN 版本(cubism.live2d.com/sdk-web/cubismcore)或更早的 SDK 版本。",
  "wife.runtime.error.downloadFailed": "下载 Cubism Core 失败。请检查网络连接后重试。",
  "wife.runtime.installing": "正在安装…",
  "wife.runtime.license": "Live2D 授权信息",
  "settings.wife.import.title": "导入 OpenCode 偏好",
  "settings.wife.import.description": "重新导入安全的界面偏好并重启；不会替换 Wife 角色或共享的 Agent 会话。",
  "settings.wife.import.action": "导入并重启",
  "settings.wife.import.working": "正在导入…",
  ...
  "wife.scan.yes": "是",
  "wife.scan.no": "否",
  "wife.mapping.states": "状态",
  "wife.mapping.gestures": "手势",
