...
const getBase = (appId: string): Configuration => ({
  artifactName: "opencode-wife-${version}-${os}-${arch}.${ext}",
  directories: {
    output: "dist",
  ...
  switch (channel) {
    case "dev": {
      return {
        ...base,
        appId,
        productName: "OpenCode Wife Dev",
        protocols: { name: "OpenCode Wife Dev", schemes: ["opencode-wife"] },
